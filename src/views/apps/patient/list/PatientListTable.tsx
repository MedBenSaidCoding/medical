...
import AddUserDrawer from './AddPatientDrawer'
...
const patientStatusObj: PatientStatusType = {
  active: 'success',
  deceased: 'warning',
  inactive: 'secondary'
}
...
const PatientListTable = ({ tableData }: { tableData?: PatientType[] }) => {
  ...
  const columns = useMemo<ColumnDef<PatientTypeWithAction, any>[]>(
    () => [
      ...
      columnHelper.accessor('dateOfBirth', {
        ...
        cell: ({ row }) => (
          <Typography className='capitalize' color='text.primary'>
            {row.original.dateOfBirth.toString()}
          </Typography>
        )
      }),
  ...
  const getAvatar = (params: Pick<PatientType, 'avatar' | 'fullName'>) => {
